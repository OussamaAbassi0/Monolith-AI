        ...
        <section id="technologie" style={{ padding: '120px 24px', position: 'relative' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto' }}>
            ...
            <div
              ...
              className={`reveal group transition-all duration-500 ease-out will-change-transform hover:-translate-y-1 hover:scale-[1.005] hover:shadow-[0_30px_80px_-20px_rgba(61,90,254,0.35),0_0_60px_-15px_rgba(0,212,170,0.18)] hover:!border-[rgba(61,90,254,0.45)]${isVisible('tech-graph') ? ' visible reveal-delay-2' : ''}`}
        ...
        <section id="contact" style={{ padding: '40px 24px 120px', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ maxWidth: 900, margin: '0 auto', position: 'relative', zIndex: 1 }}>
            ...
            >
              ...
              <div
                className="relative w-full aspect-[4/3] sm:aspect-[16/11] lg:aspect-[16/10] min-h-[560px] sm:min-h-[640px] lg:min-h-[720px]"
              >
                <iframe
                  src="https://calendly.com/monolith-ai/appel-strategie"
                  title="Réserver un appel Monolith AI"
                  loading="lazy"
                  className="absolute inset-0 h-full w-full block bg-transparent border-0"
                />
              </div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
                  {!logoError ? (
                    <div style={{ position: 'relative', width: 28, height: 28 }}>
                      <Image src="/logo.png" alt="Monolith AI" fill sizes="28px" style={{ objectFit: 'contain' }} onError={() => setLogoError(true)} />
                    </div>
                  ) : (
